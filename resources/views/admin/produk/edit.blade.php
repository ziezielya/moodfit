...
@section('title', 'Perbarui Produk - MoodFit')
    ...
    <div class="bg-white/80 backdrop-blur-md rounded-[32px] shadow-lg border border-yellow-100/80 p-6 md:p-10 transition-all duration-300">
        ...
        <div class="mb-8">
            ...
            <p class="text-xs text-amber-700/80 font-medium mt-1.5">
                Sesuaikan rincian, harga, kategori style, atau ganti gambar produk busana MoodFit Anda di bawah ini.
            </p>
        </div>
        ...
        >
                    ...
                    <div class="relative">
                        ...
                        >
                            @foreach($styles as $style)
                                <option
                                    value="{{ $style->id }}"
                                    {{ $produk->style_id == $style->id ? 'selected' : '' }}
                                >
                                    {{ $style->nama_style }}
                                </option>
                            @endforeach
            ...
            <!-- GRID: GAMBAR SAAT INI & UNGGAH BARU -->
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
                ...
                <div class="space-y-2 md:col-span-1">
                    ...
                    <div class="w-full rounded-2xl overflow-hidden border border-yellow-100 shadow-sm bg-amber-50/50 p-2">
                        <img
                ...
                <div class="space-y-2 md:col-span-2">
                    ...
                    <div class="relative group border-2 border-dashed border-yellow-200 hover:border-yellow-400 bg-[#fffaf0]/20 rounded-2xl p-4 min-h-[178px] transition-all duration-300 text-center flex flex-col items-center justify-center cursor-pointer">
                        <input
                            type="file"
                            name="gambar"
                            id="image-upload"
                        ...
                        >
                        <div id="upload-placeholder" class="space-y-2 flex flex-col items-center justify-center">
                            <div class="w-10 h-10 rounded-xl bg-amber-50 text-amber-600 flex items-center justify-center text-lg group-hover:scale-110 transition-all duration-300">
                                <i class="fas fa-cloud-upload-alt"></i>
                            </div>
                            <div>
                                <p class="text-xs font-bold text-amber-950">Klik untuk mengunggah foto baru</p>
                                <p class="text-[9px] text-amber-600/70 font-semibold uppercase tracking-wider mt-1">Kosongkan jika tidak diganti</p>
                            </div>
                        </div>
                        <div id="image-preview-container" class="hidden relative max-w-[200px] rounded-xl overflow-hidden shadow-md border border-yellow-100">
                            <img id="image-preview" src="#" alt="Pratinjau Gambar Baru" class="w-full object-cover max-h-36">
                            <button type="button" onclick="removePreview(event)" class="absolute top-1.5 right-1.5 w-6 h-6 rounded-md bg-black/60 hover:bg-black text-white flex items-center justify-center text-[10px] transition-all z-20">
